...
export const serviceOptions = [
  {
    ...
    price: 39.9,
    duration: '12 min',
    detail: 'Lavagem externa com secagem rápida',
  },
  {
    name: 'Premium',
    price: 69.9,
    duration: '20 min',
    detail: 'Espuma ativa, cera líquida e acabamento',
  },
  {
    name: 'SUV Care',
    price: 89.9,
    duration: '25 min',
    detail: 'Lavagem completa para veículos maiores',
  },
];
...
export const products = [
  ...
  { name: 'Cera', price: 24.9, image: ceraImage, imageAlt: 'Pote de cera automotiva' },
  {
    name: 'Microfibra',
    price: 14.9,
    image: microfibraImage,
    imageAlt: 'Toalha de microfibra automotiva',
  },
  {
    name: 'Aromatizador',
    price: 12.9,
    image: aromatizadorImage,
    imageAlt: 'Aromatizador automotivo',
  },
  {
    name: 'Silicone',
    price: 19.9,
    image: siliconeImage,
    imageAlt: 'Frasco de silicone automotivo',
  },
  {
    name: 'Limpa vidro',
    price: 16.9,
    image: limpaVidroImage,
    imageAlt: 'Frasco de limpa vidro automotivo',
  },
];
...
export const demoState = {
  ...
  washes: [
    ...
    },
    {
      id: 'wash-002',
      type: 'wash',
      customerId: 'demo-fleet',
      customerName: 'Recife Prime Rent',
      vehiclePlate: 'RPR4E22',
    ...
    },
    {
      id: 'wash-004',
      type: 'wash',
      customerId: 'demo-premium',
      customerName: 'Bruno Almeida',
      vehiclePlate: 'BRA1D45',
      identificationMethod: 'Placa',
      service: 'Premium',
      price: 69.9,
      paymentStatus: 'Aprovado',
